...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/13 09:23:48 by jmougel           #+#    #+#             */
/*   Updated: 2024/02/16 15:48:52 by jmougel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	event_move(t_data *data, t_charac *charac, int x, int y)
{
	...
	if (charac->life == 0)
		...
		charac->s_charac = xpm_to_img(data->p_mlx, S_C_B, &img_w, &img_h);
